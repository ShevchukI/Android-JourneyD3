...
//
//            DataBaseConverter.getInstance(getContext()).getChapterDAO().insert(chapterEntities);
//
//
//            List<Chapter> chapters = DataBaseConverter.getInstance(getContext()).getChapterDAO().getAll();
