 ...
 * {@link FragmentReward.OnFragmentInteractionListener} interface
...
public class FragmentReward extends Fragment {
    ...
    public static FragmentReward newInstance(String text) {
        FragmentReward fragment = new FragmentReward();
        Bundle args = new Bundle();
        args.putString(TEXT1, text);
        fragment.setArguments(args);
        return fragment;
    }
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
            text = getArguments().getString(TEXT1);
            Log.d(LogTag.INFORMATION, text);
        }
    }
